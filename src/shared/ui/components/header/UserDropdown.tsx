...
export default function UserDropdown() {
  ...
  const { isOpen: opendModal, openModal, closeModal } = useModal();
  ...
  return (
    <div className="relative">
      ...
      >
        <div className="no-scrollbar relative w-full max-w-[500px] overflow-y-auto rounded-2xl bg-white p-6 dark:bg-gray-900 lg:p-8 shadow-lg">
